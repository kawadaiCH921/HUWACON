...
<body>  
    ...
    <div class="ranking-container">         
        ...
        <div class="top-ranks">             
            ...
            $stmt = $pdo->prepare('SELECT user_name, clear_time FROM ranking WHERE stage_id = 3 ORDER BY clear_time ASC LIMIT 3');                 
            $stmt->execute();                 
            $rank = 1;                  
        ...
        <div class="other-ranks">             
            ...
            $stmt = $pdo->prepare('SELECT user_name, clear_time FROM ranking WHERE stage_id = 3 ORDER BY clear_time ASC LIMIT 3, 47');                 
            $stmt->execute();                 
            $rank = 4; // 4位からスタート                  
